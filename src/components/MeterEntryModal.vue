...
<style>
.meter-entry-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14rpx; }
.meter-entry-card { padding: 18rpx; border-radius: 24rpx; background: #ffffff; border: 1rpx solid rgba(226, 232, 240, 0.9); box-shadow: 0 10rpx 28rpx rgba(15, 23, 42, 0.05); }
.meter-entry-label { font-size: 24rpx; font-weight: 600; color: #475569; }
.meter-entry-input { width: 100%; height: 72rpx; margin-top: 12rpx; padding: 0 18rpx; border-radius: 20rpx; border: 1rpx solid rgba(226, 232, 240, 0.95); background: #f8fafc; font-size: 28rpx; line-height: 72rpx; font-weight: 500; color: #0f172a; box-sizing: border-box; }
.meter-entry-actions { margin-top: 12rpx; }
.meter-upload-button { width: 100%; height: 58rpx; border-radius: 18rpx; border: 1rpx solid rgba(191, 219, 254, 0.95); background: #eff6ff; color: #2563eb; font-size: 22rpx; font-weight: 600; display: flex; align-items: center; justify-content: center; }
