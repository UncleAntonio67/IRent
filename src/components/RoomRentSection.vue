...
.utility-table-head{padding:18rpx;background:#f8fafc;color:#64748b;font-size: 28rpx;font-weight:600}
.utility-table-row{padding:22rpx 18rpx;border-top:1rpx solid rgba(226,232,240,.9)}
...
.utility-type-name{font-size: 30rpx;font-weight:500;color:#0f172a}
.term-money-stack{flex-direction:column}.term-money-row{display:grid;grid-template-columns:26rpx minmax(0,1fr);column-gap:6rpx;min-width:142rpx;text-align:left;color:#0f172a;font-size: 30rpx;font-weight:500;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,'Courier New',monospace;line-height:1.2}.term-money-label{color:#94a3b8;font-size: 24rpx;text-align:right}.term-money-sub{margin-top:5rpx;color:#64748b;font-size: 26rpx}
