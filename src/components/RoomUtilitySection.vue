...
.utility-table-head,.utility-table-row{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.15fr) minmax(0,.7fr) minmax(0,.95fr);gap:12rpx;align-items:center;text-align:center}.utility-table-head{padding:18rpx;background:#f8fafc;color:#64748b;font-size:26rpx;font-weight:600}.utility-table-row{padding:20rpx 18rpx;border-top:1rpx solid rgba(226,232,240,.9)}.utility-type,.term-state,.utility-action,.term-money-stack{display:flex;align-items:center;justify-content:center;min-width:0}.utility-type-name{font-size:28rpx;font-weight:500;color:#0f172a}.term-money-stack{flex-direction:column}.term-money-row{display:grid;grid-template-columns:26rpx minmax(0,1fr);column-gap:6rpx;min-width:142rpx;text-align:left;color:#0f172a;font-size:28rpx;font-weight:500;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,'Courier New',monospace;line-height:1.2}.term-money-label{color:#94a3b8;font-size:22rpx;text-align:right}.term-money-sub{margin-top:5rpx;color:#64748b;font-size:24rpx}.term-status-lamp{width:18rpx;height:18rpx;border-radius:9999rpx;box-shadow:0 0 0 4rpx rgba(148,163,184,.08)}.term-status-lamp-done{background:#10b981}.term-status-lamp-partial{background:#f59e0b}.term-status-lamp-pending{background:#cbd5e1}.utility-action-primary{min-width:104rpx;padding:16rpx 20rpx;border-radius:14rpx;background:linear-gradient(135deg,#2563eb,#3b82f6);color:#fff;font-size:26rpx;font-weight:700;line-height:1;box-shadow:0 10rpx 18rpx rgba(37,99,235,.18)}.utility-included-text{font-size:24rpx;line-height:1.3;color:#94a3b8;font-weight:500;text-align:center}
</style>
